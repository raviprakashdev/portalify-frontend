    ...
    return (
        ...
        <div className='row top-bar align-items-center'>
            ...
            <div className="col-2">
                ...
                <div className='logo'> <img src={require('C:/Users/Khushi/Desktop/portalify-frontend/apps/portalify-website/src/app/assets/logos/Logo-white.png')} alt="logo" className="img-fluid" /> </div>
            ...
            <div className='col-2'>
                ...
                <div className='logout-dashboard d-flex justify-content-evenly align-items-center'>
                    <div className="icon"><img src={require("C:/Users/Khushi/Desktop/portalify-frontend/apps/portalify-website/src/app/assets/icons/logout_icon.png")} alt="icon" /></div>
                    <div className="user-image"><img src={require("C:/Users/Khushi/Desktop/portalify-frontend/apps/portalify-website/src/app/assets/sample-user-image.png")} alt="icon" /></div>
