      ...
      elements: [
        {
          ...
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Sample Label</label>  <input id='htmlContent' type='text'/></div>`,
        },
        {
          index: 2,
          id: uuid(),
        ...
        },
        {
          ...
          name: 'Number',
          icon: number_icon,
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Sample Label</label>   <input id='htmlContent' type='number'/></div>`,
        },
      ],
    },
    {
      ...
      elements: [
        {
          ...
          name: 'Date',
          icon: date_icon,
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Sample Label  </label>   <input id='htmlContent' type='date'/></div>`,
        },
        {
          index: 5,
          id: uuid(),
          ...
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Sample Label  </label>   <input id='htmlContent' type='datetime-local'/></div>`,
        },
      ],
    },
      ...
      elements: [
        {
          ...
          name: 'Dropdown',
          icon: dropdown_icon,
          htmlContent: `<div id='htmlContentWhole'><h1 id='htmlContentHeading'> Add Question </h1> <select id="htmlContentContainer" name="undefined"><option id=1 value='Sample'>Sample</option></select></div>`,
        },
        {
          index: 7,
          id: uuid(),
          ...
          htmlContent: `<div id='htmlContentWhole'><h1 id='htmlContentHeading'> Add Question </h1> <div id="htmlContentContainer"><div id=1 className='htmlContentParent'><input id='htmlContent' type='radio' name="undefined" value='sample'/> <label id='htmlContentLabel' for='htmlContent' > Sample </label> </div></div></div>`,
        },
        {
          index: 8,
          id: uuid(),
          name: 'Checkbox',
          icon: checkbox_icon,
          htmlContent: `<div id='htmlContentWhole'><h1 id='htmlContentHeading'> Add Question </h1> <div id="htmlContentContainer"><div id=1 className='htmlContentParent'><input id='htmlContent' type='checkbox' value='sample'/> <label id='htmlContentLabel' for='htmlContent' > Sample </label> </div></div></div>`,
        },
        {
          index: 9,
          id: uuid(),
      ...
      elements: [
        {
          ...
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Upload A Photo: </label> <input type="file" accept="image/*"></div>`,
        },
        {
          index: 11,
          id: uuid(),
          ...
          htmlContent: `<div id='htmlContentParent'><label id='htmlContentLabel' for='htmlContent'>Upload An Attachment:   </label><input type='file'></type></div>`,
        },
      ],
    },
    {
